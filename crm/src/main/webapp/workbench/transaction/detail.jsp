...
//准备以阶段为类型的字典值列表
//select * from tbl_dic_value where typeCode='stage' 9
...
<script type="text/javascript">
	...
	//改变图标样式及颜色
	function changeIcon(listStage,index1) {
