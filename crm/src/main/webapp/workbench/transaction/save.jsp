...
<script>
	...
	$(function () {
		...
		$("#create-customerName").typeahead({
			//在为文本框填写信息的时候，触发该函数，实现自动补全的操作
			/*

				参数query：我们在文本框中输入的关键字
				参数process：这是一个函数，为我们展现根据关键字搜索出来的信息
		...
		$("#create-stage").change(function () {
			...
			/*
				...
				关于可能性的取得
				阶段我们已经有了：上述变量stage
				阶段和可能性之间的对应关系：java脚本中的pMap
				什么都有，但是现在就是不能取可能性
				因为pMap是java代码
				我们现在需要将java中的键值对关系pMap，转换为js中的键值对关系来使用(json)
				pMap------>json{"01资质审查":10,"02需求分析":25......}
			...
			/*
				...
				以上做法不行，因为stage是一个变量，以一个变量为key，不能够通过传统的json.key的形式来取值
				我们需要使用json[key]的形式来取值
...
<body>
	...
	<form id="tranForm" method="post" action="workbench/transaction/save.do" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="07c154fcd174469992b48629a350852d"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="1b37c3495cbb477db951653e7da32f43"/>
			</div>
		</div>
