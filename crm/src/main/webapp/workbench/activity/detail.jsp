...
<script type="text/javascript">
	...
	$(function(){
		...
		//在页面加载完毕后，发出一个ajax请求，加载市场活动关联的备注信息列表
		showRemarkList();
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data,function (i,n) {
					...
					//如果是使用foreach动态遍历出来的元素，我们更习惯于直接以触发事件的形式来操作元素
	...
	function editRemark(id) {
		...
		/*
			...
			关于备注信息的处理
			1.取得需要修改的备注信息
			2.将备注信息填充到修改备注模态窗口的文本域中
			3.将模态窗口打开

		 */

		//1.取得需要修改的备注信息
		//找到用来承载备注信息的h5标签对，然后调用html()方法，取得里面的内容，就是我们需要修改的备注信息
