...
<script type="text/javascript">
	...
	$(function(){
		...
		//在页面加载完毕后，发出ajax请求取得关联的市场活动列表数据，展现市场活动列表
		showActivityList();

		//为搜索市场活动的文本框绑定事件，执行搜索市场活动的操作
		$("#aname").keydown(function (event) {
			...
			if(event.keyCode==13){
				...
				//在以上市场活动操作完毕之后，模态窗口会自动执行敲回车的默认事件，强制刷新页面，将所有的数据刷没
				//所以，在以上市场活动操作完毕之后，应该及时终止该方法继续执行
				return false;
		...
		$("#bundBtn").click(function () {
			...
			//肯定选中了市场活动，而且有可能选择了多条市场活动
				...
				//以上参数处理完毕后，发出ajax请求，执行线索和市场活动的关联操作
				$.ajax({
	...
	function showActivityList() {
		...
		//alert("发出ajax请求取得关联的市场活动列表数据，展现市场活动列表");
