...
public class ClueController extends HttpServlet {
    ...
    private void convert(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        /*
            ...
            调用业务层的线索转换的方法，执行线索转换的业务
            返回值：flag 表示线索转换成功还是失败
            参数：
                clueId 有了这个参数，业务层才会知道转换的是哪条线索
                t 有了这个参数，可以在执行线索转换的同时，为客户创建一笔交易（t也有可能是个null，如果t是null，表示只转换线索，不创建交易）
    ...
    private void getActivityListByNameAndNotByClueId(HttpServletRequest request, HttpServletResponse response) {
        ...
        System.out.println("查询市场活动列表（根据名称模糊查+排除掉已经关联指定clueId的市场活动）");
    ...
    private void getActivityListByClueId(HttpServletRequest request, HttpServletResponse response) {
        ...
        System.out.println("根据线索id，取得关联的市场活动列表");
